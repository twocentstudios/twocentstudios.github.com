...
Coming off some headwinds with [my last rewrite experience](/2025/06/22/vinylogue-swift-rewrite/), I finally decided to check the status of my codebase after over 2 years of dormancy. As I suspected, Claude Code made quick work of updating all my iOS code to my preferred architecture and the latest APIs. Unfortunately, the Vapor framework was a lot further behind the Swift 6 migration than I'd hoped, but still has reasonable support for most bread-and-butter web app capabilities.
