...
{% caption_img /images/print-design-iphones-early-era-320pt.jpg iPhone, iPhone 3G, iPhone 4, and iPhone 5 — all 320 points wide %}
...
Until [Sketch](https://www.sketch.com/) gained some prominence in the 2013-2015 era, Photoshop was still the most popular tool for less technical designers to work in before artifact hand off.

{% caption_img /images/print-design-sketch-ios-artboard-presets.jpg Sketch app showing iOS device artboard presets including iPhone 6, iPhone 5, and iPad sizes %}
...
{% caption_img /images/print-design-iphones-various-sizes.jpg iPhone 6 (375pt), iPhone X (375pt), iPhone 13 (390pt), and iPad Air (768pt) %}
...
- For Dark Mode, we have semantic colors like `.label`, `.background`, `.secondary`, `.blue`, `.tint`, and asset catalogs.
...
{% caption_img /images/print-design-hig-semantic-label-colors.jpg HIG semantic label colors adapt automatically across appearances %}

{% caption_img /images/print-design-hig-system-colors.jpg HIG system colors vary across light mode, dark mode, and increased contrast %}
...
I knew the signs of the mindset shift, and they all came like manna from heaven. I'd start to receive mockups with loading states leading to the happy path. I'd get error messages with [HIG](https://developer.apple.com/design/human-interface-guidelines/)-respectful copywriting. I'd get sidecar notes in the margins pointing out fixed and flexible dimensions. I'd get line limits for text. I'd see table cells with long and short user names. With empty and populated avatar images. The apps were starting to show signs of *being apps* before I'd actually turned them into living & breathing apps.
...
- Immersing in Apple-sanctioned resources like the [HIG](https://developer.apple.com/design/human-interface-guidelines/), [WWDC videos](https://developer.apple.com/videos/), and learning how to search, read, and understand the developer [documentation](https://developer.apple.com/documentation).
...
- Do the painful work of watching over a user's shoulder as they tap through *your* app on *their* 8 year old iPhone with *their* settings and *their* cracked screen.
